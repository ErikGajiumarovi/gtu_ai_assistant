...
def capabilities():
    return {
        ...
        "filesystemPolicy": "Each run starts in a new temp directory under /workspace/tmp and is deleted after the run. No app, repo, DB, MinIO, Docker socket, or host volumes are mounted.",
